// /store/calculator/calculatorSlice.ts
...
const calculatorSlice = createSlice({
  ...
  reducers: {
    ...
    updateYearlyTotals: (
      state,
      action: PayloadAction<UpdateYearlyTotalsPayload>
    ) => {
...
export const { addProduct, removeProduct, updateProduct, updateYearlyTotals } =
