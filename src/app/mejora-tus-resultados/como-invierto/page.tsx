    ...
    <main className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <div className="ml-1">
          ...
          <ul className="list-disc list-inside space-y-2 my-4 ml-2">
            <li>
              <strong>10%</strong> a un plan de pensiones indexado al S&P 500
              con MyInvestor 📈.
            </li>
            <li>
      ...
      <section className="mb-8">
        ...
        <div className="ml-1">
          ...
          <ul className="list-disc list-inside space-y-2 my-4 ">
            ...
            <li>
              <strong>Revolut</strong> para mi cuenta remunerada, aprovechando
              su interés diario en el plan gratuito 🌐.
            </li>
          </ul>
          <p>
      ...
      <section className="mb-8">
        ...
        <div className="ml-1">
          <p>
            Considerado la{" "}
            <strong>&quot;octava maravilla del mundo&quot;</strong>, el interés
          ...
          <p>
            Este simple ejemplo muestra cómo tu inversión inicial crece más de
            un 60% sin esfuerzo adicional de tu parte. El secreto está en
            comenzar lo antes posible y mantener tus ahorros invirtiendo a largo
            plazo.
          </p>
          <p className="mt-2">
            Con <strong>aportaciones regulares</strong> y el tiempo de tu lado,
            el interés compuesto puede ser el motor que impulse tus finanzas
