...
export default function MyProfits() {
    return (
        <div>
            ...
            <p className="mb-2 mt-4">A continuación, con mis rentabilidades te enseño una <strong>simulación durante 25 años</strong>:</p>
            <ul className="list-disc list-inside space-y-1 my-4 ml-2">
                <li>Capital inicial de 1.000€ en cada producto.</li>
                <li>Aportaciones mensuales de 200€ en fondos de inversión y cuenta remunerada.</li>
            ...
            <p className='mt-2'>Observa cómo en los <strong>últimos años el efecto del interés compuesto impulsa el valor de los ahorros</strong>, demostrando su poder para transformar aportaciones regulares en un patrimonio considerable.</p>
            </div>
        </div>
    )
}
